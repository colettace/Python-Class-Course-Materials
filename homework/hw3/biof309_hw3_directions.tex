...
\begin{itemize}
  ...
  \item You can create a simple regular expression that returns all words in a string by splitting on character or sequence of characters that are \textbf{non-alphanumeric}.
